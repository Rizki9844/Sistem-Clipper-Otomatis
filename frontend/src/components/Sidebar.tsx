    ...
    return (
        <aside className="fixed left-0 top-0 h-screen flex flex-col glass z-50"
            ...
            <div className="px-4 py-4 border-t border-white/5 space-y-2">
                    ...
                    <div className="glass-card px-4 py-3 space-y-2">
                        <div className="flex items-center justify-between">
                            <span className="text-[11px] text-slate-400 font-medium">
                                {quota.plan_tier === "free" ? "🆓 Free Plan" : "⭐ Pro Plan"}
                            </span>
                            <span className={`text-[11px] font-semibold ${quotaPct! >= 90 ? "text-rose-400" : quotaPct! >= 60 ? "text-amber-400" : "text-emerald-400"}`}>
                                {quota.used}/{quota.limit} videos
                            </span>
                        </div>
                        <div className="w-full h-1.5 rounded-full bg-white/5 overflow-hidden">
                            <div
                        ...
                        {quota.remaining === 0 && (
                            <p className="text-[10px] text-rose-400">Quota habis. Upgrade ke Pro!</p>
                        )}
                    </div>
                )}
                {quota?.unlimited && (
                    <div className="glass-card px-4 py-2 flex items-center gap-2">
                        <span className="text-[11px] text-violet-400">⭐ Pro — Unlimited</span>
                    </div>
                )}
                ...
                <div className="glass-card px-4 py-2 text-center">
                    <p className="text-[11px] text-slate-500">v0.3.0 · FastAPI + Next.js</p>
                </div>
            </div>
        </aside>
    );
